  ...
  TimeAgo = (function() {
    ...
    TimeAgo.prototype.distanceOfTimeInWords = function(absolutTime) {
      ...
      if (dim === 0) {
        ...
        return "pre 1 " + this.options.lang.units.minute;
      } else if (dim >= 2 && dim <= 44) {
        return "pre " + dim + " " + this.options.lang.units.minutes;
      } else if (dim >= 45 && dim <= 89) {
        return "pre " + this.options.lang.prefixes.about + " 1 " + this.options.lang.units.hour;
      } else if (dim >= 90 && dim <= 1439) {
        return "pre " + this.options.lang.prefixes.about + " " + (Math.round(dim / 60)) + " " + this.options.lang.units.hours;
      } else if (dim >= 1440 && dim <= 2519) {
        return "pre 1 " + this.options.lang.units.day;
      } else if (dim >= 2520 && dim <= 43199) {
        return "pre " + (Math.round(dim / 1440)) + " " + this.options.lang.units.days;
      } else if (dim >= 43200 && dim <= 86399) {
        return "pre " + this.options.lang.prefixes.about + " 1 " + this.options.lang.units.month;
      } else if (dim >= 86400 && dim <= 525599) {
        return "pre " + (Math.round(dim / 43200)) + " " + this.options.lang.units.months;
      } else if (dim >= 525600 && dim <= 655199) {
        return "pre " + this.options.lang.prefixes.about + " 1 " + this.options.lang.units.year;
      } else if (dim >= 655200 && dim <= 914399) {
        return "pre " + this.options.lang.prefixes.over + " 1 " + this.options.lang.units.year;
      } else if (dim >= 914400 && dim <= 1051199) {
        return "pre " + this.options.lang.prefixes.almost + " 2 " + this.options.lang.units.years;
      } else {
        return "pre " + this.options.lang.prefixes.about + " " + (Math.round(dim / 525600)) + " " + this.options.lang.units.years;
      }
    };
